// Qawser Qayoom Extended Futuristic Portfolio // React + Framer Motion + Light Blue + Gold Glow + Lightning + Long Sections

import React from "react"; import { motion } from "framer-motion";

export default function QawserPortfolio() { const sectionStyle = { border: "1px solid #00ffff", borderRadius: "12px", padding: "30px", marginBottom: "40px", backgroundColor: "rgba(255, 255, 255, 0.03)", boxShadow: "0 0 25px rgba(0, 255, 255, 0.3)", };

const handleFlashClick = () => { const flash = document.createElement("div"); flash.style.position = "fixed"; flash.style.top = 0; flash.style.left = 0; flash.style.width = "100vw"; flash.style.height = "100vh"; flash.style.background = "radial-gradient(circle, #00ffff88 0%, transparent 80%)"; flash.style.pointerEvents = "none"; flash.style.zIndex = 9999; flash.style.animation = "flashFade 0.5s ease-out"; document.body.appendChild(flash); setTimeout(() => flash.remove(), 500); };

return ( <main style={{ padding: "40px", maxWidth: "900px", margin: "auto" }}> <motion.h1 onClick={handleFlashClick} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 2 }} style={{ fontSize: "60px", fontWeight: "bold", fontFamily: "Segoe UI, sans-serif", color: "#00ffff", textShadow: "0 0 10px #00ffff, 0 0 20px #00ffff, 0 0 40px #FFD700, 0 0 80px #FFD700", whiteSpace: "nowrap", overflow: "hidden", animation: "typing 3s steps(30) forwards, blink 0.7s step-end infinite", borderRight: "2px solid #00ffff", cursor: "pointer", }} > Qawser Qayoom </motion.h1>
